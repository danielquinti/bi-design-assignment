...
-- Comprobar BD
-- SELECT 
--     'SELECT ''' || table_name || ''' AS tabla, COUNT(*) AS total FROM ' || table_name || ' UNION ALL' AS script_conteo
-- FROM 
--     user_tables;
-- Nota: Al ejecutar el resultado, recuerda quitar el último 'UNION ALL'

SELECT 'BRIDGE_ACTIVITY_GROUP' AS tabla, COUNT(*) AS total FROM BRIDGE_ACTIVITY_GROUP UNION ALL
SELECT 'DIM_ACTIVITY' AS tabla, COUNT(*) AS total FROM DIM_ACTIVITY UNION ALL
SELECT 'DIM_ACTIVITY_GROUP' AS tabla, COUNT(*) AS total FROM DIM_ACTIVITY_GROUP UNION ALL
SELECT 'DIM_CHANNEL' AS tabla, COUNT(*) AS total FROM DIM_CHANNEL UNION ALL
SELECT 'DIM_DATE' AS tabla, COUNT(*) AS total FROM DIM_DATE UNION ALL
SELECT 'DIM_JUNK_STATUS' AS tabla, COUNT(*) AS total FROM DIM_JUNK_STATUS UNION ALL
SELECT 'DIM_STREAMING_SESSION' AS tabla, COUNT(*) AS total FROM DIM_STREAMING_SESSION UNION ALL
SELECT 'DIM_TIME' AS tabla, COUNT(*) AS total FROM DIM_TIME UNION ALL
SELECT 'DIM_VIEWER' AS tabla, COUNT(*) AS total FROM DIM_VIEWER UNION ALL
SELECT 'DIM_VIEWER_CHANNEL_ROLE' AS tabla, COUNT(*) AS total FROM DIM_VIEWER_CHANNEL_ROLE UNION ALL
SELECT 'FACT_INTERACTION' AS tabla, COUNT(*) AS total FROM FACT_INTERACTION UNION ALL
SELECT 'FACT_VIEW' AS tabla, COUNT(*) AS total FROM FACT_VIEW;
